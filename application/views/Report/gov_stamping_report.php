      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12 mt-1">
            <h4>Govt Stamping Register Report</h4>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card-header">
              <h3 class="card-title"><i class="fa fa-list"></i> Govt Stamping Register Report</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              ...
              <?php if(isset($gov_report)){ ?>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                      $i=0;
                      foreach ($gov_stamping_list as $list) {
                      $i++;
                    ?>
                    <tr>
                      <td><?php echo $i; ?></td>
