        ...
        <div class="row">
          ...
          <div class="col-md-10 offset-md-1">
            ...
            <div class="card card-default">
              ...
              <!-- form start -->
              <?php if(isset($update)){ ?>
                <form role="form" action="../update_party" method="post">
                  <input type="hidden" name="party_id" value="<?php echo $party_id; ?>">
              <?php } else{ ?>
                <form role="form" action="save_party" method="post">
              <?php } ?>

                <div class="card-body row">

                  <div class="form-group col-md-12">
                    <input type="text" class="form-control" name="party_firm" id="party_firm" value="<?php if(isset($party_firm)){ echo $party_firm;} ?>" placeholder="Enter Name of Firm" required>
                  </div>
                  <div class="form-group col-md-12">
                    <textarea class="form-control" rows="3" name="party_address" id="party_address" placeholder="Enter Address" required><?php if(isset($party_address)){ echo $party_address;} ?></textarea>
                  </div>
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control" name="party_area" id="party_area" value="<?php if(isset($party_area)){ echo $party_area;} ?>" placeholder="Enter Area/Village/Town" required>
                  </div>
                  <div class="form-group col-md-6">
                  ...
                  <div class="form-group col-md-6">
                    <input type="number" class="form-control" name="party_pin" id="party_pin" value="<?php if(isset($party_pin)){ echo $party_pin;} ?>" placeholder="Enter Pincode" required>
                  </div>
                  <div class="form-group col-md-6">
                    <input type="number" class="form-control" name="party_mob1" id="party_mob1" value="<?php if(isset($party_mob1)){ echo $party_mob1;} ?>" placeholder="Mobile No. 1" required>
                  </div>
                  <div class="form-group col-md-6">
