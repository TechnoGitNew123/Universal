      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card-body" >
              <?php if(isset($update)){ ?>
                <form role="form" action="<?php echo base_url(); ?>Transaction/update_delivery_challan" method="post">
                  <input type="hidden" name="delivery_id" value="<?php echo $delivery_id; ?>">
              <?php } else{ ?>
                <form role="form" action="<?php echo base_url(); ?>Transaction/save_delivery_challan" method="post">
              <?php } ?>
                ...
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-8 offset-md-2">
                    <select class="form-control select2 form-control-sm" name="delivery_party" id="delivery_party" style="width: 100%;" required>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group" >
                    <textarea id="txt_terms" class="form-control form-control-sm" name="delivery_terms" id="delivery_terms" rows="8" ><?php if(isset($delivery_terms)){ echo $delivery_terms; } ?></textarea>
                  </div>
