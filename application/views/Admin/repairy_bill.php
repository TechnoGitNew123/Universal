              ...
              <?php } ?>
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-4">
                    <input type="text" class="form-control form-control-sm" name="repairy_date" id="date1" value="<?php if(isset($repairy_date)){ echo $repairy_date; } ?>" data-target="#date1" data-toggle="datetimepicker" placeholder="Repairy Receipt Date" required>
                  </div>
                ...
                <div class="col-md-6 " >
                  ...
                  <table class="table float-right gst-table" >
                    ...
                    <tr class="mt-4">
                      ...
                      <td  ><input type="text" class="form-control" name="repairy_basic_charge" id="repairy_basic_charge" value="<?php if(isset($repairy_basic_charge)){ echo $repairy_basic_charge; } ?>"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td  ><input type="text" class="form-control" name="repairy_total" id="repairy_total" value="<?php if(isset($repairy_total)){ echo $repairy_total; } ?>"></td>
                    </tr>
                  </table>
                </div>
                </div>
...
// var i = 1;
  $('#add_row').click(function(){
    ...
    var row = '<tr>'+
                ...
                '</td>'+
                '<td>'+
                  '<select class="form-control form-control-sm"  name="input['+i+'][capacity_id]" required>'+
                    '<option value="">Select Capacity</option>'+
                    <?php foreach ($capacity_list as $capacity_list1) { ?>
                      '<option value="<?php echo $capacity_list1->capacity_id; ?>"><?php echo $capacity_list1->capacity_name ?></option>'+
                    <?php } ?>
                ...
                '</td>'+
                '<td>'+
                  '<select class="form-control form-control-sm"  name="input['+i+'][accuracy_id]" required>'+
                    '<option value="">Select Accuracy</option>'+
                    <?php foreach ($accuracy_list as $accuracy_list1) { ?>
                      '<option value="<?php echo $accuracy_list1->accuracy_id; ?>"><?php echo $accuracy_list1->accuracy_name ?></option>'+
                    <?php } ?>
                ...
                '</td>'+
                '<td>'+
                  '<select class="form-control form-control-sm" name="input['+i+'][class_id]" required>'+
                    '<option value="">Select Class</option>'+
                    <?php foreach ($class_list as $class_list1) { ?>
                      '<option value="<?php echo $class_list1->class_id; ?>"><?php echo $class_list1->class_name ?></option>'+
                    <?php } ?>
