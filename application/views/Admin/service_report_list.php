                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="edit_service/<?php echo $list->complaint_id; ?>"> <i class="fa fa-edit"></i> </a>
                      <a class="ml-4" href="delete_service/<?php echo $list->complaint_id; ?>" onclick="return confirm('Delete Confirm');"> <i class="fa fa-trash"></i> </a>
                      <?php } ?> -->
                      <a class="ml-4" href="<?php echo base_url(); ?>Receipt/service_report/<?php echo $list->complaint_id; ?>"> <i class="fa fa-print"></i> </a>
                    </td>
                  </tr>
                <?php } ?>
                </tbody>
